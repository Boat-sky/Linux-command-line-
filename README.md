...
---
สามารถใช้ `pkill -9 python` เพื่อล้าง memory ของโปรแกรมที่รันค้างได้ แต่ถ้ายังไม่หาย ลองใช้ foce kill เช่นต้องการ kill ทุก py ไฟล์ที่ขึ้นต้นด้วย filter_map2
```
pkill -9 -f "python filter_map2"
```
